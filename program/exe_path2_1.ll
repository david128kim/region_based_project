; ModuleID = 'program/path_2_1.c'
source_filename = "program/path_2_1.c"
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 0) #2
  %4 = load i32, i32* @num, align 4, !tbaa !1
  %5 = add nsw i32 %4, -1
  store i32 %5, i32* @num, align 4, !tbaa !1
  %6 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 0) #2
  %7 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @empty) #3
  %8 = load i32, i32* @total, align 4, !tbaa !1
  %9 = add nsw i32 %8, 1
  store i32 %9, i32* @total, align 4, !tbaa !1
  %10 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %9) #2
  %11 = load i32, i32* @num, align 4, !tbaa !1
  %12 = add nsw i32 %11, -1
  store i32 %12, i32* @num, align 4, !tbaa !1
  %13 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 1) #2
  %14 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @empty) #3
  %15 = load i32, i32* @num, align 4, !tbaa !1
  %16 = add nsw i32 %15, 1
  store i32 %16, i32* @num, align 4, !tbaa !1
  %17 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 0) #2
  %18 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @full) #3
  %19 = load i32, i32* @num, align 4, !tbaa !1
  %20 = add nsw i32 %19, 1
  store i32 %20, i32* @num, align 4, !tbaa !1
  %21 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 1) #2
