; ModuleID = 'program/path_1_4.c'
source_filename = "program/path_1_4.c"
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %7 = tail call i32 @pthread_cond_wait(%union.pthread_cond_t* nonnull @empty, %union.pthread_mutex_t* nonnull @m) #4
  %8 = load i32, i32* @num, align 4, !tbaa !1
  %9 = add nsw i32 %8, 1
  store i32 %9, i32* @num, align 4, !tbaa !1
  %10 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 1) #3
  %11 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @full) #4
