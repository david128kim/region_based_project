; ModuleID = 'program/path_2_4.c'
source_filename = "program/path_2_4.c"
...
@num = global i32 16843009, align 4
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %15 = tail call i32 @pthread_cond_wait(%union.pthread_cond_t* nonnull @empty, %union.pthread_mutex_t* nonnull @m) #4
  ...
  %20 = tail call i32 @pthread_cond_wait(%union.pthread_cond_t* nonnull @empty, %union.pthread_mutex_t* nonnull @m) #4
  ...
  %24 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @full) #4
  ret i32 0
}
