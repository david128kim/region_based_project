; ModuleID = 'program/path_1_2.c'
source_filename = "program/path_1_2.c"
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %12 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i32 %11) #3
  %13 = load i32, i32* @num, align 4, !tbaa !1
  %14 = add nsw i32 %13, -1
  store i32 %14, i32* @num, align 4, !tbaa !1
  %15 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 0) #3
  %16 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @empty) #4
  %17 = tail call i32 @pthread_cond_wait(%union.pthread_cond_t* nonnull @full, %union.pthread_mutex_t* nonnull @m) #4
