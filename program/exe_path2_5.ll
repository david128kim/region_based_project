; ModuleID = 'program/path_2_5.c'
source_filename = "program/path_2_5.c"
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %8 = tail call i32 @pthread_cond_wait(%union.pthread_cond_t* nonnull @full, %union.pthread_mutex_t* nonnull @m) #4
  %9 = load i32, i32* @total, align 4, !tbaa !1
  %10 = add nsw i32 %9, 1
  store i32 %10, i32* @total, align 4, !tbaa !1
  %11 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %10) #3
  %12 = load i32, i32* @num, align 4, !tbaa !1
  %13 = add nsw i32 %12, -1
  store i32 %13, i32* @num, align 4, !tbaa !1
  %14 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32 1) #3
  %15 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @empty) #4
  %16 = load i32, i32* @num, align 4, !tbaa !1
  %17 = add nsw i32 %16, 1
  store i32 %17, i32* @num, align 4, !tbaa !1
  %18 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 0) #3
  %19 = tail call i32 @pthread_cond_signal(%union.pthread_cond_t* nonnull @full) #4
